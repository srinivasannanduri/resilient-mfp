...
@Path("/")
public class HATestAdapterResource {
	/*
	...
	static Logger logger = Logger.getLogger(HATestAdapterResource.class.getName());
	...
	/*
	 * Path for method:
	 * "<server address>/mfp/api/adapters/HATestAdapter/resource"
	 */
	...
	/*
	 * Path for method:
	 * "<server address>/mfp/api/adapters/HATestAdapter/resource/greet?name={name}"
	 */
	...
	/*
	 * Path for method:
	 * "<server address>/mfp/api/adapters/HATestAdapter/resource/{path}/"
	 */
	...
	/*
	 * Path for method:
	 * "<server address>/mfp/api/adapters/HATestAdapter/resource/prop"
	 */
	...
	/*
	 * Path for method:
	 * "<server address>/mfp/api/adapters/HATestAdapter/resource/unprotected"
	 */
	...
	/*
	 * Path for method:
	 * "<server address>/mfp/api/adapters/HATestAdapter/resource/protected"
	 */
